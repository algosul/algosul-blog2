...
/** @type {string} */
const CACHE_VERSION = '1777711328|1284423954';
/** @type {string} */
const CACHE_PREFIX = '零号种子-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = '零号种子.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["零号种子.html","零号种子.js","零号种子.offline.html","零号种子.icon.png","零号种子.apple-touch-icon.png","零号种子.audio.worklet.js","零号种子.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["零号种子.wasm","零号种子.pck","零号种子.side.wasm"];
